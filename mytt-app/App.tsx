  ...
  screenOptions={({ route }) => ({
    tabBarIcon: ({ focused}) => {
      ...
      if (route.name === 'Home') {
        ...
        icon = focused ? <Image source={require('./assets/bookmarkActive.png')} style={{ width: 20, height: 24 }} /> : <Image source={require('./assets/bookmarkGrey.png')} style={{ width: 20, height: 24, opacity: 0.5 }} />;
